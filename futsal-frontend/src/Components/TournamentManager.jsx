...
export default function TournamentManager() {
    ...
    const fetchSettingsAndGroups = () => {
        fetch('http://proleague-api.somee.com/api/Tournament/settings') // عدل الرابط هنا لو لزم الأمر
            .then(res => res.json())
            .then(data => setSettings(data));

        fetch('http://proleague-api.somee.com/api/Tournament/groups') // وهنا
            .then(res => res.json())
            .then(data => {
    ...
    const handleDrawGroups = async () => {
        try {
            ...
            const teamsRes = await fetch('http://proleague-api.somee.com/api/teams');
