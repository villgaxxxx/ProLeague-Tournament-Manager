...
export default function TournamentManager() {
    ...
    // الدالة دي لسه موجودة عشان بتغذي قائمة التبديل بأسماء الفرق
    const fetchAllTeams = async () => {
        try {
            ...
            console.error("مشكلة في جلب الفرق:", error);
        }
    };
    ...
    const handleSwapTeams = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // الشاشة هتعمل ريفرش للمجموعات أوتوماتيك بعد التبديل
                fetchSettingsAndGroups(); 
            } else {
                alert(data.message || data.Message);
            }
    ...
    return (
        <div className="max-w-5xl mx-auto mt-8 px-4" dir="rtl">
            ...
            {/* لوحة تحكم الإدمن */}
            {isAdmin && (
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200 mb-8 max-w-4xl mx-auto">
            ...
            {settings.isGroupStageDrawn && (
                <div>
                    ...
                    {/* 🔄 واجهة تبديل الفرق */}
                    {isAdmin && (
                        <div className="bg-yellow-50 border border-yellow-300 p-6 rounded-xl shadow-sm mb-8 text-center max-w-4xl mx-auto">
