...
export default function AdminSchedule() {
    ...
    const fetchDrafts = () => {
        ...
        fetch('http://proleague-api.somee.com/api/Tournament/draft-matches', {
    ...
    const handleGenerate = async () => {
        const token = localStorage.getItem('adminToken');
        const res = await fetch('http://proleague-api.somee.com/api/Tournament/generate-schedule', {
    ...
    const handleDateChange = async (matchId, newDate) => {
        const token = localStorage.getItem('adminToken');
        await fetch(`http://proleague-api.somee.com/api/Tournament/update-date/${matchId}`, {
            method: 'PUT',
    ...
    const handlePublish = async () => {
        ...
        const token = localStorage.getItem('adminToken');
        const res = await fetch('http://proleague-api.somee.com/api/Tournament/publish-matches', {
